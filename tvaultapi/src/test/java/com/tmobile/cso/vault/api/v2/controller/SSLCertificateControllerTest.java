...
public class SSLCertificateControllerTest {
    ...
    public void test_generateSSLCertificate_success() {
        ...
        when(sslCertificateService.generateSSLCertificate(sSLCertificateRequest)).thenReturn(new ResponseEntity<>(HttpStatus.OK));
        assertEquals(HttpStatus.OK, SslCertificateController.generateSSLCertificate(sSLCertificateRequest).getStatusCode());
    }
    ...
    public void test_generateSSLCertificate_Error() {
        ...
        when(sslCertificateService.generateSSLCertificate(sSLCertificateRequest)).thenReturn(new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR));
        assertEquals(HttpStatus.INTERNAL_SERVER_ERROR, SslCertificateController.generateSSLCertificate(sSLCertificateRequest).getStatusCode());
