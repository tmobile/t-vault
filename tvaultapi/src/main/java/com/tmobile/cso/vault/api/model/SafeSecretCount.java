 ...
 *
 */
public class SafeSecretCount implements Serializable{


	private static final long serialVersionUID = -7842940357412288003L;

	int totalCount;
	Map<String, Integer> safeSecretCount;

	public SafeSecretCount() {
		super();
	}

	public SafeSecretCount(int totalCount, Map<String, Integer> safeSecretCount) {
