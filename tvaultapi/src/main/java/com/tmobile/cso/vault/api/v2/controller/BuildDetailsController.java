...
@RestController
@CrossOrigin
@Api( description = "Build Details Controller", position = 15)
public class BuildDetailsController {
	 ...
	 * @return
	 */
	@GetMapping(value="/v2/build/details",produces="application/json")
	@ApiOperation(value = "${BuildDetailsController.getBuildDetails.value}", notes = "${BuildDetailsController.getBuildDetails.notes}")
