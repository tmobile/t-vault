...
//import com.tmobile.cso.vault.api.utils.G
...
public class RequestProcessor {
    ...
    public CertResponse processCert(String apiEndPoint, Object request, String accessToken, String certManagerEndPoint) throws Exception {
        ...
        try {
            ...
            response.setResponse("{\"errors\":[\"End point is not not found/configured.\"]}");
            log.error(JSONUtil.getJSON(ImmutableMap.<String, String>builder().
                    put(LogMessage.USER, ThreadLocalContext.getCurrentMap().get(LogMessage.USER).toString()).
                    put(LogMessage.ACTION, "Process Request").
                    put(LogMessage.MESSAGE, String.format("Processing input for [%s] for request failed", apiEndPoint)).
        ...
        ResponseEntity<String> certManagerResponse = null;
        ...
        switch (apiConfig.getMethod()) {
            case "POST":
                log.debug(JSONUtil.getJSON(ImmutableMap.<String, String>builder().
                        put(LogMessage.USER, ThreadLocalContext.getCurrentMap().get(LogMessage.USER).toString()).
                        put(LogMessage.ACTION, "Process Request").
                        put(LogMessage.MESSAGE, String.format("Calling the CertManager end point [%s] using post method", certManagerEndPoint)).
                        put(LogMessage.APIURL, ThreadLocalContext.getCurrentMap().get(LogMessage.APIURL).toString()).
                        build()));
                certManagerResponse = certRestprocessor.post(certManagerEndPoint.toString(), accessToken, request);
                break;
            case "PUT":
                log.debug(JSONUtil.getJSON(ImmutableMap.<String, String>builder().
                        put(LogMessage.USER, ThreadLocalContext.getCurrentMap().get(LogMessage.USER).toString()).
                        ...
                        put(LogMessage.APIURL, ThreadLocalContext.getCurrentMap().get(LogMessage.APIURL).toString()).
                        build()));
                certManagerResponse = certRestprocessor.put(certManagerEndPoint.toString(), accessToken, request);
                break;
            case "GET":
                log.debug(JSONUtil.getJSON(ImmutableMap.<String, String>builder().
                        put(LogMessage.USER, ThreadLocalContext.getCurrentMap().get(LogMessage.USER).toString()).
                        put(LogMessage.ACTION, "Process Request").
                        put(LogMessage.MESSAGE, String.format("Calling the CertManager end point [%s] using get method", certManagerEndPoint)).
                        put(LogMessage.APIURL, ThreadLocalContext.getCurrentMap().get(LogMessage.APIURL).toString()).
                        build()));
                certManagerResponse = certRestprocessor.get(certManagerEndPoint.toString(), accessToken);
                break;
            case "DELETE":
                log.debug(JSONUtil.getJSON(ImmutableMap.<String, String>builder().
                        put(LogMessage.USER, ThreadLocalContext.getCurrentMap().get(LogMessage.USER).toString()).
        ...
        log.debug(JSONUtil.getJSON(ImmutableMap.<String, String>builder().
                put(LogMessage.USER, ThreadLocalContext.getCurrentMap().get(LogMessage.USER).toString()).
                put(LogMessage.ACTION, "PROCESS REQUEST").
                put(LogMessage.MESSAGE, String.format("NCLM Endpoint  = [%s] ,  Request to NCLM  = [%s]  , " +
                                "Response from  NCLM = [%s]",
                        certManagerEndPoint, JSONUtil.getJSONasDefaultPrettyPrint(request),
                        certManagerResponse)).
                put(LogMessage.APIURL, ThreadLocalContext.getCurrentMap().get(LogMessage.APIURL).toString()).
                build()));

        Map<String, Object> certManagerResponseMap = new HashMap<String, Object>();
        if (null != certManagerResponse && !HttpStatus.NO_CONTENT.equals(certManagerResponse.getStatusCode())) {
        ...
        log.debug(JSONUtil.getJSON(ImmutableMap.<String, String>builder().
                put(LogMessage.USER, ThreadLocalContext.getCurrentMap().get(LogMessage.USER).toString()).
                put(LogMessage.ACTION, "RESPONSE FROM processCert :").
                put(LogMessage.MESSAGE, String.format("RESPONSE  = [%s]  ", response)).
                put(LogMessage.APIURL, ThreadLocalContext.getCurrentMap().get(LogMessage.APIURL).toString()).
                build()));
        return response;
    }
